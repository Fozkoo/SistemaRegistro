      ...
      <div className="bg-white shadow-md">
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between py-4">
            <div className='w-full pl-[45%]'> {/* a revisar */}
          ...
          <div className="block sm:hidden bg-white border-t-2 py-2">
            <div className="flex justify-center gap-[10%]">
              <a href="#" className="text-gray-800 text-sm font-semibold hover:text-purple-600 mb-1">Alumnos</a>
              <a href="#" className="text-gray-800 text-sm font-semibold hover:text-purple-600 mb-1">Hombres</a>
              <a href="#" className="text-gray-800 text-sm font-semibold hover:text-purple-600 mb-1">Mujeres</a>
              <a href="#" className="text-gray-800 text-sm font-semibold hover:text-purple-600 mb-1">Docentes</a>
